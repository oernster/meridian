...
meridian/
  ...
  ui/
    ...
    qml/
      ...
      LicenceDialog.qml     A licence: plain text in a fixed-width face. The content only: the dialog itself is a ReadingDialog
