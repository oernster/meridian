  ...
  <channel>
    ...
    <item>
      ...
      <enclosure url="https://podcast.example.com/ep1.mp3"
                 type="audio/mpeg" length="10000000"/>
      ...
      <podcast:transcript url="https://podcast.example.com/ep1.txt"
...
<rss version="2.0" xmlns:itunes="{_ITUNES_NS}">
  <channel>
    ...
    <item>
      ...
      <pubDate>Mon, 01 Jan 2026 00:00:00 +0000</pubDate>
      <enclosure url="https://podcast.example.com/ep2.mp3"
...
class TestPodcastParser:
    def test_type_is_audio(self):
        items, _ = podcast_parser.parse(
            1, "https://podcast.example.com/feed.xml", _PODCAST_FEED
        )
    ...
    def test_duration_mmss(self):
        items, _ = podcast_parser.parse(
            1, "https://podcast.example.com/feed.xml", _PODCAST_SIMPLE
        )
...
<rss version="2.0" xmlns:itunes="{_ITUNES_NS_L}">
  <channel><title>T</title>
    <item>
      ...
      <pubDate>Mon, 01 Jan 2026 00:00:00 +0000</pubDate>
      <enclosure url="https://podcast.example.com/s.mp3"
                 type="audio/mpeg" length="100000"/>
    ...
    def test_duration_invalid_raises_none(self):
        from meridian.infrastructure.fetching.parser.podcast_parser import (
            _parse_duration,
        )
        import defusedxml.ElementTree as ET
...
<rss version="2.0" xmlns:itunes="{_ITUNES_NS_L}">
  <channel><title>T</title>
    <item>
      ...
      <pubDate>Mon, 01 Jan 2026 00:00:00 +0000</pubDate>
      <enclosure url="https://podcast.example.com/ns.mp3"
                 type="audio/mpeg" length="100000"/>
    </item>
  </channel>
</rss>""".encode()
...
<rss version="2.0" xmlns:itunes="{_ITUNES_NS_L}" xmlns:podcast="{_PC_NS_L}">
  <channel><title>T</title>
    <item>
      ...
      <pubDate>Mon, 01 Jan 2026 00:00:00 +0000</pubDate>
      <enclosure url="https://podcast.example.com/tr.mp3"
                 type="audio/mpeg" length="100000"/>
...
<rss version="2.0" xmlns:itunes="{_ITUNES_NS_L}">
  <channel><title>T</title><ttl>bad</ttl>
    <item>
      ...
      <pubDate>Mon, 01 Jan 2026 00:00:00 +0000</pubDate>
      <enclosure url="https://podcast.example.com/ttl.mp3"
                 type="audio/mpeg" length="100000"/>
    </item>
  </channel>
</rss>""".encode()
