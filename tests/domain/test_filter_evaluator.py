...
class TestBooleanOps:
    ...
    def test_nested_parens(self):
        ...
        assert not _eval('NOT tag:"sponsored" AND (type:article OR type:newsletter)', item)
...
class TestInvalidTokens:
    ...
    def test_eval_date_range_bracket(self):
        item = _item(published=datetime(2026, 6, 1, tzinfo=timezone.utc))
        assert _eval('published:[2026-01-01T00:00:00+00:00,2026-12-31T00:00:00+00:00]', item)
...
class TestDeduplication:
    def test_dedup_by_canonical_url(self):
        items = [
            _item(item_id="https://example.com/1", canonical_url="https://canonical.com/x"),
            _item(item_id="https://example.com/2", canonical_url="https://canonical.com/x"),
            _item(item_id="https://example.com/3", canonical_url="https://canonical.com/y"),
        ]
